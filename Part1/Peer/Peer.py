import sys
import socket
from Part1.Threads.Peer_Client_Thread2 import *
from Part1.Threads.Peer_Server_Thread2 import *
import random
from pickle import *
import hashlib
from Part1.Peer.PDU2 import *
...
class Peer:
    ...
    def join_chord(self):
        try:
            ...
            join_pdu = PDU(1, "join", self.TTL, self.local_peer_CID, self.local_host_ip, self.local_host_port, "join the network", "")
...
if __name__ == "__main__":
    ...
    if option == '-p':
        if sys.argv[3] == "-I":
            p = Peer(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6])
        else:
            p = Peer(sys.argv[1], sys.argv[2], "", "", sys.argv[3], sys.argv[4])
    elif option == '-I':
        p = Peer(sys.argv[1], sys.argv[2], "", "", sys.argv[3], sys.argv[4])
    elif option == "-t":
