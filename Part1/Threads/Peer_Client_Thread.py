                ...
                for x in self.local_peer.chord_net_peers:
                    if x['id'] == remote_peer_CID:
                      ...
                      # establish connection to remote peer and send message
                        ...
                        # prepare message
                        pdu = PDU(1, "message", self.local_peer.TTL, self.local_peer.local_peer_CID, self.local_peer.local_host_ip, self.local_peer.local_host_port, message, "Dumb Message ")
